...
//			Toast.makeText(context, "checkConnection - no connection found",
//					Toast.LENGTH_LONG).show();
    ...
    private Bitmap processBitmap(String data) {
        ...
        synchronized (mHttpDiskCacheLock) {
            ...
            if (mHttpDiskCache != null) {
                ...
                initHttpDiskCache();
                bitmap = downloadUrlToBitmap(data);
            }
        }
    ...
    public Bitmap downloadUrlToBitmap(String urlString) {
        ...
        try {
            ...
            conn = createConnection(urlString, null);

            int redirectCount = 0;
            while (conn.getResponseCode() / 100 == 3 && redirectCount < 3) {
            ...
            Log.e(TAG, "Error in image url string - " + e);
        } finally {
            if (conn != null) {
                conn.disconnect();
            }
