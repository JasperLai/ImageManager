...
public class ImageCache {
	 ...
	 * 2.3的缓存大小为1m.
	 */
	private static final int DEFAULT_MEM_CACHE_SIZE_IN_API_10 = 1024;

	// Default disk cache size in bytes
	private static final int DEFAULT_DISK_CACHE_SIZE = 1024 * 1024 * 10; // 10MB

	public static final int BITMAP_STORAGE_DEFAULT = 0;
	public static final int BITMAP_STORAGE_FOREVER = 1;

	// Compression settings when writing images to disk cache
	private static final CompressFormat DEFAULT_COMPRESS_FORMAT = CompressFormat.JPEG;
	private static final int DEFAULT_COMPRESS_QUALITY = 70;
	private static final int DISK_CACHE_INDEX = 0;
	private static final int FIXED_CACHE_SIZE = 5;
	...
	// 为特殊需求增加不回收的cache;
	private LinkedHashMap<String, BitmapDrawable> mFixedCache;
	...
	private void init(ImageCacheParams cacheParams) {
		...
		if (mCacheParams.memoryCacheEnabled) {
			...
			mFixedCache = new LinkedHashMap<String, BitmapDrawable>(
					FIXED_CACHE_SIZE);
	...
	public void addBitmapToCache(String data, BitmapDrawable value,
		...
		if (storageType == BITMAP_STORAGE_DEFAULT) {
			// Add to memory cache
			...
			if (mFixedCache != null && mFixedCache.size() < FIXED_CACHE_SIZE) {

				mFixedCache.put(data, value);
			}
		}
	 ...
	 */
	public void addBitmapToCache(String data, BitmapDrawable value) {
		addBitmapToCache(data, value, BITMAP_STORAGE_DEFAULT);
	}
	...
	public void removeCache(String data) {
		...
		try {
			if (mDiskLruCache.get(hashKeyForDisk(data)) != null) {
	...
	public BitmapDrawable getBitmapFromMemCache(String data) {
		...
		if (memValue == null) {
			memValue = mFixedCache.get(data);
			if (memValue != null) {
				Log.d(TAG, "Fixed cache hit");
			}
		}
	...
	public static class ImageCacheParams {
		 ...
		 * appended to the application cache directory. Usually "cache" or
		...
		public ImageCacheParams(Context context, String diskCacheDirectoryName) {
			...
			if (Build.VERSION.SDK_INT <= VERSION_CODES.GINGERBREAD_MR1) {
				memCacheSize = DEFAULT_MEM_CACHE_SIZE_IN_API_10;
			}
		}
